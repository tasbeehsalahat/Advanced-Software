const { updateuser , join ,shownotification,match,informations,LendMaterial, LendCenter,chooseMaterial,statusTask,joinjob} = require('./user.controller.js');
...
router.post('/joinjob',authenticateJWT,joinjob);
